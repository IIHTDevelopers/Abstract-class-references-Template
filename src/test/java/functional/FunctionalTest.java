...
public class FunctionalTest {
	...
	String filePath = "src/main/java/com/yaksha/assignment/AbstractionAndAbstractClassReferencesAssignment.java";
	...
	public void testMethodOperationsOnly() throws Exception {
		...
		boolean result = autoGrader.testAbstractionAndAbstractClassReferences(filePath);
